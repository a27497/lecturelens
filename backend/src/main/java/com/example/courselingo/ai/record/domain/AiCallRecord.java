...
public class AiCallRecord {
    ...
    @TableField("input_units")
    private Integer inputUnits;

    @TableField("output_units")
    private Integer outputUnits;

    @TableField("request_fingerprint")
    private String requestFingerprint;

    @TableField("response_fingerprint")
    ...
    public Integer getInputUnits() {
        return inputUnits;
    }

    public void setInputUnits(Integer inputUnits) {
    ...
    public void setResponseFingerprint(String responseFingerprint) {
